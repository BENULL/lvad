...
from models.msg3d.kinetics import AdjMatrixGraph
...
class Model(nn.Module):
    def __init__(self,
        ...
        self.num_node = A_binary.shape[1]
        ...
        # r=3 STGC blocks
        self.gcn3d1 = MultiWindow_MS_G3D(self.in_channels, c1, A_binary, num_g3d_scales, window_stride=1)
        self.sgcn1 = nn.Sequential(
            MS_GCN(num_gcn_scales, self.in_channels, c1, A_binary, disentangled_agg=True),
            MS_TCN(c1, c1),
            MS_TCN(c1, c1))
        ...
        self.fcn_out = self.num_node*self.in_channels*6
